...
public class values {
    ...
    public static final String release_json = "\"0.2.6_007\"";
    public static final int build_json = 007;
    public static final String database_revision = "DSR4";
    public static final String build = "007";
